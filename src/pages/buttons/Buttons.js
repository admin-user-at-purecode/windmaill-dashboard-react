...
import { CTA, PageTitle, SectionTitle } from '../../components/button/buttonpage'
...
function Buttons() {
  return (
    <>
      ...
      <div className="primaryButtons flex flex-col flex-wrap mb-8 space-y-4 md:flex-row md:items-end md:space-x-4">
        <div>
      ...
      <div className="outlineButtons flex flex-col flex-wrap mb-8 space-y-4 md:flex-row md:items-end md:space-x-4">
        <div>
      ...
      <div className="Links flex flex-col flex-wrap mb-8 space-y-4 md:flex-row md:items-end md:space-x-4">
        <div>
      ...
      <div className="Icons flex flex-col flex-wrap mb-8 space-y-4 md:flex-row md:items-end md:space-x-4">
        <div>
